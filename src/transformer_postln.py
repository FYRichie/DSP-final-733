...
class TransformerLayer(nn.Module):
    ...
    def forward(self, x, kv=None, self_padding_mask=None, self_attn_mask=None, external_memories=None, external_padding_mask=None, need_weights=False):
    ...
    def work_incremental(self, x, self_padding_mask, self_attn_mask, incremental_state):
        ...
        x, self_attn = self.self_attn(
            query=x, key=x, value=x, key_padding_mask=self_padding_mask, attn_mask=self_attn_mask, incremental_state=incremental_state
        )
        x = self.attn_layer_norm(residual + x)
